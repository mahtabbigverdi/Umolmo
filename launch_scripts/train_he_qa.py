...
if __name__ == "__main__":
    ...
    model_cfg.data_formatter.prompt_type = "uber_model"
    model_cfg.data_formatter.message_formatting = "role"
    model_cfg.data_formatter.system_prompt_kind = "demo_or_style"
    if args.n_high_res:
    ...
    if isinstance(model_cfg, HeMolmoConfig):
        ...
        model_cfg.mm_preprocessor.max_query_len = 128
        model_cfg.mm_preprocessor.multi_res_min = None
        model_cfg.mm_preprocessor.multi_res_selection = None
    else:
        seq_len = 1664

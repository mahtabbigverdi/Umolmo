"""
Implementation of torch.distributed.checkpoint.StorageWriter/StorageReader that supports remote urls

From https://github.com/allenai/OLMo-core/blob/main/src/olmo_core/distributed/checkpoint/filesystem.py
"""
